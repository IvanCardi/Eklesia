...
public class Validator {
    ...
    public static boolean validation(Map<Integer, String> map, String password, TextInputEditText nome, TextInputEditText cognome, TextInputEditText email, TextInputEditText pwd, TextInputEditText conferma_pwd, TextInputEditText data) {
